                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <form class="form" action="{{ route('update.brand', $brand->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group mb-2">
                                        ...
                                        <input class="form-control @error('brand_name')
                                            is-invalid
                                        @enderror " type="text" name="brand_name" id="" value="{{ $brand->brand_name }}">
                                        @error('brand_name')
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <img src="{{ asset($brand->brand_img) }}" alt="" height="200px" width="200px" class="img-thumbnail img-fluid mt-2">
                                    </div>
